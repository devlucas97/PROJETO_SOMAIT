...
_raw_password = os.getenv("APP_PASSWORD", "azzas2026")
                ...
                try:
                    ...
                    if dados["status"] == "Danificado":
                        ...
                        if marca_lower == "dell":
                            ...
                            destino_log = "TI + Dell (cotação)"
                    else:
                        enviar_email(dados)
                    enviar_email_rh(dados, para=email_rh_dest)
                    destino_log += " + RH"
                    registrar_email_enviado(novo_id, destino_log)
...
def salvar_chamado_dell(id_devolucao):
    ...
    try:
        atualizar_chamado_dell(id_devolucao, chamado or None)
