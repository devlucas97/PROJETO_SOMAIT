...
def _obter_config_planilha():
    ...
    if not planilha and os.path.exists(config_file):
        try:
...
def inserir(dados):
    ...
    try:
        ...
        logger.warning("Falha ao sincronizar planilha corporativa: %s", err)
...
def atualizar(id_devolucao, dados):
    ...
    try:
        ...
        logger.warning("Falha ao sincronizar planilha corporativa após edição: %s", err)
...
def excluir(id_devolucao):
    ...
    try:
        ...
        logger.warning("Falha ao sincronizar planilha após exclusão: %s", err)
...
def atualizar_chamado_dell(id_devolucao, chamado):
    ...
    try:
        ...
        logger.warning("Falha ao sincronizar planilha após atualização de chamado Dell: %s", err)
